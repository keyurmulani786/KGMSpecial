...
public class ArraySumUsingSet {
    ...
    /**
     * * Given an array of integers finds two elements in the array whose sum
     * is equal to n.
     *
    ...
    public static void printPairsUsingSet(int[] numbers, int n) {
        ...
        Set<Object> set = new HashSet<>(numbers.length);
        for (int value : numbers) {
            int target = n - value;
            System.out.println("target::"+target+" ,n::"+n+" ,value::"+value);
