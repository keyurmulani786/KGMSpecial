...
//        int[][] g = parentToG(par);
        ...
        for (int z = 0; z < Q; z++) {
            ...
            if (t == 'Q') {
                ...
                System.out.println("x::" + x + " ,v::" + v + "::" + (long) Math.sqrt(v));
                System.out.println("v0::" + v0 + " ,v1::" + v1);
                long value = (long) (Math.sqrt(v));
                System.out.println(flag + "value::" + value);
                if (flag) {
                    System.out.println(mms + "::" + value + " ,prev::" + prevValue);
                    if (value != prevValue) {
//                        mms=+value;
                        prevValue = value;
                        mms += value;
                    ...
                    System.out.println("QQ::" + mms);
                    out.println(mms);
                } else {
                    mms = mms + (f[dep[x] + 1 + 1] * v0 + f[dep[x] + 1] * v1) % mod;
                    System.out.println("UU side::" + mms);
                    out.println(mms);
//                    mms++;
                    flag = true;
                }
...
//                System.out.println(Arrays.deepToString(System.currentTimeMillis()-s+"ms"));
        if (!INPUT.isEmpty()) {
            tr(System.currentTimeMillis() - s + "ms");
        }
    }
